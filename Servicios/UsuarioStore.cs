...
namespace ManejoPresupuestoNetCore.Servicios
{
    ...
    {
        private readonly IRepositorioUsuarios repositorioUsarios;

        public UsuarioStore(IRepositorioUsuarios repositorioUsuarios) 
        {
            this.repositorioUsarios = repositorioUsuarios;
        }
        public async Task<IdentityResult> CreateAsync(Usuario user, CancellationToken cancellationToken)
        {
            user.Id = await repositorioUsarios.CrearUsuario(user);
        ...
        {
            return await repositorioUsarios.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await repositorioUsarios.BuscarUsuarioPorEmail(normalizedUserName);
        }
